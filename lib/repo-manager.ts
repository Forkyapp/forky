...
async function createGitHubRepo(
  ...
  try {
    ...
    console.log(jarvis.warning(`Could not auto-create via gh CLI: ${(error as Error).message}`));
...
async function cloneRepository(owner: string, repoName: string, targetPath: string): Promise<void> {
  ...
  try {
    ...
    console.log(jarvis.error(`Failed to clone repository: ${(error as Error).message}`));
    throw error;
  }
}
...
async function addToReposConfig(repoName: string, repoConfig: RepositoryConfig): Promise<void> {
  ...
  try {
    ...
    console.log(jarvis.error(`Failed to update repos.json: ${(error as Error).message}`));
    throw error;
  }
}
...
async function ensureRepository(repoName: string, options: EnsureRepoOptions = {}): Promise<RepositoryConfig> {
  ...
  try {
    ...
    console.log(jarvis.error(`Auto-create failed: ${(error as Error).message}`));
